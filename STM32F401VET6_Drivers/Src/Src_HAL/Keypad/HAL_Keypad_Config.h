...
/***************************************************/
#define KEYPAD_ROW_BUS		PHB1_GPIOC
#define KEYPAD_ROW_PORT 	GPIOC_PORT
/*--------------------------------------*/
#define KEYPAD_R0_PIN	  	GPIO_PIN_1
#define KEYPAD_R1_PIN	  	GPIO_PIN_2
#define KEYPAD_R2_PIN	  	GPIO_PIN_3
#define KEYPAD_R3_PIN	  	GPIO_PIN_4
/***************************************************/
/***************************************************/
#define KEYPAD_COL_BUS   	PHB1_GPIOC
#define KEYPAD_COL_PORT 	GPIOC_PORT
/*--------------------------------------*/
